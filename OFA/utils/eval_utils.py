...
def eval_caption(task, generator, models, sample, outType, **kwargs):
...
def eval_step(task, generator, models, sample, outType, **kwargs): #viren
    if task.cfg._name == 'caption':
        return eval_caption(task, generator, models, sample, outType, **kwargs)
